...
namespace FortuneTeller
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string vacationHome = "outhouse";

                if (siblings == 0)
                   {

                      vacationHome = "Mansion";
                    }
                 
                else if (siblings == 1)
                    {

                       vacationHome = "Townhouse";
                    }

                else if (siblings == 2)
                    {

                        vacationHome == "House Boat";
                    }

                 else if (siblings == 3)
                   {

                        vacationHome == "Starship Enterprise"
                   }

                 else (siblings > 3)
                  {
                        vacationHome == "Double Wide Trailer"
                   }
        }        
